...
#include "image_micrograph_local_quality.h"
//#define DEBUG
//#define DEBUG_MASK

void ProgMicLocQuality::readParams()
{
	fnImg = getParam("--odd_frames");
	fnImg = getParam("--even_frames");
}


void ProgMicLocQuality::defineParams()
{
